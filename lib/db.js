...
// their external endpoints. Some auto-injected connection strings don't
// spell out `sslmode=require`, and without an explicit `ssl` option `pg`
// defaults to a plain connection, which those providers reject outright.
// `rejectUnauthorized: false` skips CA verification rather than failing
// closed — acceptable here since the connection string itself (host +
